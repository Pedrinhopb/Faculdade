...
CREATE TABLE `semestres` (
  ...
  `CodigoSemestre` varchar(10) DEFAULT NULL,
  `AbertoParaMatricula` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`ID_Semestre`),
  UNIQUE KEY `CodigoSemestre` (`CodigoSemestre`)
...
INSERT INTO `semestres` VALUES (1,'2026.1',1);
