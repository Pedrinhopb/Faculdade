...
CREATE TABLE `prerequisitos` (
  ...
  CONSTRAINT `prerequisitos_ibfk_1` FOREIGN KEY (`ID_Disciplina_Principal`) REFERENCES `disciplinas` (`ID_Disciplina`) ON DELETE RESTRICT ON UPDATE CASCADE,
  CONSTRAINT `prerequisitos_ibfk_2` FOREIGN KEY (`ID_Disciplina_PreRequisito`) REFERENCES `disciplinas` (`ID_Disciplina`) ON DELETE RESTRICT ON UPDATE CASCADE
...
INSERT INTO `prerequisitos` VALUES (2,1);
